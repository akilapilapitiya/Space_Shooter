...
public:
    AsteroidDodger()
        : window(sf::VideoMode(800, 600), "Asteroid Dodger"), playerSpeed(300.f), asteroidSpeed(200.f),
          spawnInterval(1.f), score(0), gameOver(false), inMenu(true), multiplayerMode(false) {
...
private:
    ...
    void setupViews() {
        ...
        view1.setSize(355, 555);
        view1.setCenter(200, 300);
        view1.setViewport(sf::FloatRect(0.f, 0.f, 0.5f, 1.f));

        view2.setSize(500, 700);
        view2.setCenter(600, 300);
    ...
    void render() {
        ...
        if (inMenu) {
            ...
            if (multiplayerMode) {
                ...
                sf::RectangleShape border(sf::Vector2f(2.f, static_cast<float>(window.getSize().y)));
                border.setFillColor(sf::Color::White);
                border.setPosition(view1.getSize().x - border.getSize().x, 0.f);
                window.draw(border);
