...
public:
    AsteroidDodger()
        ...
        player2.setPosition(100.f, 500.f); // Position second player at the top
...
private:
    ...
    void spawnAsteroid() {
        ...
        asteroid.setScale(0.3f, 0.3f); // Scale down the asteroid sprite
